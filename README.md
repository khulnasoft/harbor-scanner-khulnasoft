...
(`aquasec/harbor-scanner-khulnasoft`). There is no difference in functionality though.
...
1. Install the `harbor-scanner-khulnasoft` chart:
...
2. Configure the scanner adapter in the Harbor interface.
   ...
   2. Enter <http://harbor-scanner-khulnasoft.harbor:8080> as the **Endpoint** URL and click **TEST CONNECTION**.
...
| `SCANNER_KHULNASOFT_CACHE_DIR`               | `/home/scanner/.cache/trivy`       | Trivy cache directory                                                                                                                                                                                                                                                              |
| `SCANNER_KHULNASOFT_REPORTS_DIR`             | `/home/scanner/.cache/reports`     | Trivy reports directory                                                                                                                                                                                                                                                            |
...
- [Architecture](./docs/ARCHITECTURE.md) - architectural decisions behind designing harbor-scanner-khulnasoft.
- [Releases](./docs/RELEASES.md) - how to release a new version of harbor-scanner-khulnasoft.
...
[docker-pulls-aqua]: https://img.shields.io/docker/pulls/aquasec/harbor-scanner-khulnasoft?logo=docker&label=docker%20pulls%20%2F%20aquasec
