...
// Command represents the CLI interface for the Khulnasoft Enterprise scanner,
...
func (c *command) Scan(imageRef ImageRef) (report ScanReport, err error) {
	...
	reportFile, err := c.ambassador.TempFile(c.cfg.ReportsDir, "khulnasoft_scan_report_*.json")
	if err != nil {
